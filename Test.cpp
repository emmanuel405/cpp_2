...
TEST_CASE("init Tree"){
    Tree *t = new Tree("Shany");
    CHECK_NOTHROW(t->addFather("Shany", "Emmanuel"));
    CHECK_NOTHROW(t->addMother("Shany", "Lea"));
...
TEST_CASE("test of function addFather"){
    ...
    // l.remove("Levi");
    CHECK_NOTHROW(l.addFather("Moshe", "Amram"));
    CHECK_NOTHROW(l.addFather("Amram", "Kehat"));
    CHECK_NOTHROW(l.addFather("Kehat", "Levi"));
...
TEST_CASE("init Tree"){
    Tree *a_i = new Tree("Reuven");
    CHECK_NOTHROW(a_i->addFather("Reuven", "Yaakov"));
    CHECK_NOTHROW(a_i->addMother("Reuven", "Lea"));
...
TEST_CASE("init tree"){
    Tree *t = new Tree("Yehoshafat");
    CHECK_NOTHROW(t->addFather("Yehoshafat", "Assa"));
